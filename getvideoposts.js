...
async function run() {
  ...
  try {
    ...
    const collection = database.collection('videos'); // Use the 'poll' collection
    ...
    console.log("Total : ", Object.keys(obj).length);
    

    // save post_ids to file _ids.json
    fs.writeFileSync('./helpers/aws.videos.json', JSON.stringify(Object.keys(obj), null, 2));
